...
document.querySelectorAll(".btnEditarDespesa").forEach(function(botao){
    botao.onclick=function(){
        editarDespesa(this.dataset.id);
    };

});

document.querySelectorAll(".btnExcluirDespesa").forEach(function(botao){
    botao.onclick=function(){
        excluirDespesa(this.dataset.id);
    };
});
